...
router.put('/update/:id', upload.single('image'), verifyToken, async (req, res) => {
    ...
    try {
        ...
        errorResponse(res, 500, 'Server or DB error, failed to update report', err.message);
    }
});
...
router.get('/', async (req, res) => {
    try {
        ...
        errorResponse(res, 500, "Server or database error, Get reports failed", err.message);
    }
});
